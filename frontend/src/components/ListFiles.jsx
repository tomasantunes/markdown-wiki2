  ...
  function submitSetSortIndex(e) {
    ...
    .then(function(response) {
      if (response.data.status == "OK") {
        ...
        .then(function(value) {
          var modal = bootstrap.Modal.getOrCreateInstance(document.querySelector('.setSortIndexModal'))
          modal.hide();
        })
      }
      else {
  ...
  function submitEditCategoryName(e) {
    ...
    .then(function(response) {
      if (response.data.status == "OK") {
        MySwal.fire(response.data.data)
        .then(function(value) {
          var modal = bootstrap.Modal.getOrCreateInstance(document.querySelector('.editCategoryNameModal'))
          modal.hide();
