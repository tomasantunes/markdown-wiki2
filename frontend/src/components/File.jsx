...
export default function File({id}) {
  ...
  function showEditFile(id) {
    ...
    .then(function(response) {
      ...
      if (response.data.status == "OK") {
        ...
        var modal = bootstrap.Modal.getOrCreateInstance(document.querySelector("#editFileModal" + id))
        modal.show();
      }
      else {
  ...
  function showEditImage(id) {
    ...
    .then(function(response) {
      if (response.data.status == "OK") {
        ...
        var modal = bootstrap.Modal.getOrCreateInstance(document.querySelector("#editImageModal" + id))
        modal.show();
      }
      else {
        MySwal.fire(response.data.error);
  ...
  function closeAppendModal() {
    var modal = bootstrap.Modal.getOrCreateInstance(document.querySelector("#appendModal" + id))
    modal.hide();
  }
